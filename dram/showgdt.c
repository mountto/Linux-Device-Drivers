//******************************************************************
//	showgdt.c
//	Thu 3, ngay 6 thang 7 nam 2021
//	This program uses our 'dram.c' device-driver to display the
//	current processor's Global Descriptor Table in hex format.
//
//		compile using:  $ g++ showgdt.c -o showgdt
//		execute using:  $ ./showgdt
// Linux murt-VPCEH28FJ 5.8.0-59-generic #66~20.04.1-Ubuntu SMP Thu Jun 17 11:14:10 UTC 2021 x86_64 x86_64 x86_64 GNU/Linux
//
...
//#define START_KERNEL_map 0xC0000000   for 32bit
