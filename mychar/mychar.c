 ...
 * @file   mychar.c
 * @author Murt Meiv
 * @date   Thu 5, ngay 1 thang 7 nam 2021
 * @version 0.1
 * @brief   An introductory character driver to support the second article of my series on
 * Linux loadable kernel module (LKM) development. This module maps to /dev/mychar and
 ...
 * $ cat /dev/mychar or ./testmychar (source code testmychar.c)
 */
...
#define  CLASS_NAME  "mychar_classname"        ///< The device class -- this is a character device driver

MODULE_LICENSE("GPL");            ///< The license type -- this affects available functionality
MODULE_AUTHOR("Murt Meiv");    ///< The author -- visible when you use modinfo
MODULE_DESCRIPTION("A simple Linux char driver for the MyChar");  ///< The description -- see modinfo
...
static int __init mychar_init(void){
   ...
   mycharDevice = device_create(mycharClass, NULL, dev_num, NULL, DEVICE_NAME);
